...
const ChooseUsUpdate = () => {
  const [data, setData] = useState<ChooseUsData>({
    title: "Why we stand out together",
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await axios.post(`${BASE_URL}/choose-us`, payload);
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 md:p-6">
      <h1 className="text-2xl font-bold mb-6">Edit Why Choose Us Section</h1>
